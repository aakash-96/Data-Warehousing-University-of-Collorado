...
INSERT INTO faculty
	(FacNo, FacFirstName, FacLastName, FacCity, FacState,
	 ...
	 VALUES ('543-21-0987','VICTORIA','EMMANUEL','BOTHELL','WA','MS','PROF',120000.0,'',STR_TO_DATE('15-Apr-2001','%d-%b-%Y'),'98011-2242');

INSERT INTO faculty
	(FacNo, FacFirstName, FacLastName, FacCity, FacState,
	 FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode)
	 VALUES ('765-43-2109','NICKI','MACON','BELLEVUE','WA','FIN','PROF',65000.00,'',STR_TO_DATE('11-Apr-2002','%d-%b-%Y'),'98015-9945');

INSERT INTO faculty
	(FacNo, FacFirstName, FacLastName, FacCity, FacState,
	 FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode)
	 VALUES ('654-32-1098','LEONARD','FIBON','SEATTLE','WA','MS','ASSC',70000.00,'543-21-0987',STR_TO_DATE('01-May-1999','%d-%b-%Y'),'98121-0094');

INSERT INTO faculty
	(FacNo, FacFirstName, FacLastName, FacCity, FacState,
	 FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode)
	 VALUES ('098-76-5432','LEONARD','VINCE','SEATTLE','WA','MS','ASST',35000.00,'654-32-1098',STR_TO_DATE('10-Apr-2000','%d-%b-%Y'),'98111-9921');

INSERT INTO faculty
	(FacNo, FacFirstName, FacLastName, FacCity, FacState,
	 FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode)
	 VALUES ('876-54-3210','CRISTOPHER','COLAN','SEATTLE','WA','MS','ASST',40000.00,'654-32-1098',STR_TO_DATE('01-Mar-2004','%d-%b-%Y'),'98114-1332');

INSERT INTO faculty
	(FacNo, FacFirstName, FacLastName, FacCity, FacState,
	 FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode)
	 VALUES ('987-65-4321','JULIA','MILLS','SEATTLE','WA','FIN','ASSC',75000.00,'765-43-2109',STR_TO_DATE('15-Mar-2005','%d-%b-%Y'),'98114-9954');
